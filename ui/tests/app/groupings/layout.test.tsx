...
describe('GroupingsLayout', () => {
   it('renders the heading with correct props and children correctly', () => {
       ...
       render(<GroupingsLayout>
           {mockChildren}
       </GroupingsLayout>);

       expect(screen.getByText('Manage My Groupings')).toBeInTheDocument();
       expect(screen.getByText( 'View and manage groupings I own. Manage members, ' +
           'configure grouping options and sync destinations.')).toBeInTheDocument();
